...
module load samtools/1.9            # view (filter-qchr/convert) sort index
...
path2dupsmarked=${path2datadir}'gen/nguyen_nc_2018/20190909-markdups-DRB/ind1/genomic/dupsmarked/'
...
path2qchrfil=${path2genomic}'qchrfil/'

## make directories for each 'deposit data' path above
mkdir $path2bqsrbams
# qchrfil stands for quality and chromosome filter
mkdir $path2qchrfil
